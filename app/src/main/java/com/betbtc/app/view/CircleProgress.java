...
public class CircleProgress extends View {
    ...
    public CircleProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        default_text_size = CommonUtil.sp2px(getContext(), 18);
        min_size = (int) CommonUtil.dp2px(getContext(), 100);
    ...
    protected void initByAttributes(TypedArray attributes) {
        ...
        title = attributes.getString(R.styleable.CircleProgress_circle_title);
    ...
    protected void initPainters() {
        ...
        titlePaint.setTextSize(CommonUtil.dp2px(getContext(),2)+textSize);
    ...
    public String getDrawText() {
        return  "x"+CommonUtil.formatDouble(100d/getProgress());
    }
...
//        canvas.drawArc(rectF, 90 - angle, angle * 2, false, paint);
        ...
        if (!TextUtils.isEmpty(text)) {
            float textHeight = getTextHeight(textPaint,text);
            canvas.drawText(title, (getWidth() - titlePaint.measureText(title)) / 2.0f, getWidth()/2-CommonUtil.dp2px(getContext(),5) , titlePaint);
            canvas.drawText(text, (getWidth() - textPaint.measureText(text)) / 2.0f, getWidth()/2+textHeight , textPaint);
        }
    }

    public float getTextHeight(Paint paint,String text){
