package com.betbtc.app.tools.glide;
...
public class RadiusTransformation extends BitmapTransformation {
    ...
    public RadiusTransformation(Context context, int radius) {
        this.radius = CommonUtil.dp2px(context, radius);
    }

    public RadiusTransformation(Context context, int radius, boolean centerCrop) {
        this.radius = CommonUtil.dp2px(context, radius);
